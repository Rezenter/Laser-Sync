...
//EDIT HERE!
const unsigned int laserPulseCount = 49; //set the number of allowed laser pulses here
const unsigned int frequencyCounter = 2372; // set the frequency here. 717 => 330.3[Hz]; 2372 => 100.0[Hz]
