...
const int ignoreWidth = 1000000; //microseconds to ignore start signals
...
void loop() {
  if(phase){
    ...
    detachInterrupt(digitalPinToInterrupt(interruptPin_debug))
  ...
  if(allowStart && (micros() - allowStart > ignoreWidth)){
    allowStart = 0;
